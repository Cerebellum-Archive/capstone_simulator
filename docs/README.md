...
Comprehensive overview of all implemented strategies with preprocessing, learning algorithms, and portfolio construction:

| Strategy | Preprocessing | Learner | Portfolio Construction | Key Parameters |
|----------|---------------|---------|----------------------|----------------|
| **mt_linear_std_EqualWeight** | StandardScaler | LinearRegression | Equal allocation across predictions | `base_leverage=1.0` |
| **mt_linear_std_ConfidenceWeighted** | StandardScaler | LinearRegression | Prediction magnitude weighting | `max_leverage=2.0` |
| **mt_linear_std_LongShort** | StandardScaler | LinearRegression | Long top tercile, short bottom tercile | `base_leverage=1.0` |
| **mt_huber_std_EqualWeight** | StandardScaler | HuberRegressor (ε=1.35) | Equal allocation across predictions | `base_leverage=1.0` |
| **mt_huber_std_ConfidenceWeighted** | StandardScaler | HuberRegressor (ε=1.35) | Prediction magnitude weighting | `max_leverage=2.0` |
| **mt_huber_std_LongShort** | StandardScaler | HuberRegressor (ε=1.35) | Long top tercile, short bottom tercile | `base_leverage=1.0` |
| **mt_elasticnet_std_EqualWeight** | StandardScaler | ElasticNet (α=0.01, l1_ratio=0.5) | Equal allocation across predictions | `base_leverage=1.0` |
| **mt_elasticnet_std_ConfidenceWeighted** | StandardScaler | ElasticNet (α=0.01, l1_ratio=0.5) | Prediction magnitude weighting | `max_leverage=2.0` |
| **mt_elasticnet_std_LongShort** | StandardScaler | ElasticNet (α=0.01, l1_ratio=0.5) | Long top tercile, short bottom tercile | `base_leverage=1.0` |
| **st_rf_ewm_Binary** | EWMTransformer (halflife=4) | RandomForestRegressor | Binary long/short based on prediction sign | `n_estimators=50` |
| **st_rf_ewm_Quartile** | EWMTransformer (halflife=4) | RandomForestRegressor | Quartile-based position sizing (0%, 33%, 67%, 100%) | `n_estimators=50` |
| **st_rf_ewm_Proportional** | EWMTransformer (halflife=4) | RandomForestRegressor | Position size proportional to prediction | `n_estimators=50` |
